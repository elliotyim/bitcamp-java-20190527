...
public class MemberServlet implements Servlet {
  ...
  private void updateMember(ObjectInputStream in,
      ObjectOutputStream out) throws Exception {
  ...
  private void detailMember(ObjectInputStream in,
      ObjectOutputStream out) throws Exception {
    int no = in.readInt();
  ...
  private void deleteMember(ObjectInputStream in,
      ObjectOutputStream out) throws Exception {
    int no = in.readInt();
  ...
  private void addMember(ObjectInputStream in,
      ObjectOutputStream out) throws Exception {
    Member member = (Member)in.readObject();
  ...
  private void listMember(ObjectInputStream in,
      ObjectOutputStream out) throws Exception {
    out.writeUTF("ok");
