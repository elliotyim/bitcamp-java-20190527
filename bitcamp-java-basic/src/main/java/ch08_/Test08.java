...
public class Test08 {
  ...
  public static void main(String[] args) {
    ...
    switch (op) {
      ...
      //
      case "+": result = ch08_.util.Calculator2.plus(a, b); break;
      case "-": result = ch08_.util.Calculator2.minus(a, b); break;
      case "*": result = ch08_.util.Calculator2.multiple(a, b); break;
      case "/": result = ch08_.util.Calculator2.divide(a, b); break;
      default:
