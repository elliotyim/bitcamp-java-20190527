...
public class Test01 {
  ...
  public static void main(String[] args) {
    ...
    // 인스턴스의 값 변수에 무효한 값이 들어가지 않도록 해야 한다.
    ...
    p3.setName("이철희");
    p3.setAge(300); // 캡슐화를 무너뜨릴 수 있는 유효하지 않은 값은 무시된다.
    p3.setWeight(-50); // 캡슐화를 무너뜨릴 수 있는 유효하지 않은 값은 무시된다.
    p3.setHeight(400); // 캡슐화를 무너뜨릴 수 있는 유효하지 않은 값은 무시된다.
    p3.setGender(3); // 캡슐화를 무너뜨릴 수 있는 유효하지 않은 값은 무시된다.
